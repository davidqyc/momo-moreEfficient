...
这部分**源码主线已经完成，正在做发布前的真机体验比较；当前公开 TestFlight build `1.0 (3)` 里还没有这个功能**。
...
接下来会做一次真机体验比较，选出**实际更省事的日常路径**。最终不一定长期保留两个同等重要的入口。
...
| 阅读时抓词 | **即将上线** | 源码已完成；正在做快捷指令 / 共享的真机体验比较，之后再决定下一版怎么发布 |
